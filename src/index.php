                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="<?=$dropdownId?>" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="dropdown-button-<?=$row['nim']?>">
                                        ...
                                        <li>
                                            <button id="delete-button-<?=$row['nim']?>" type="button" data-modal-target="<?=$modalId?>" data-modal-toggle="<?=$modalId?>" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
